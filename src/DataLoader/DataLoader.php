 ...
 * @template TKey
 * @template T
 * @template-implements DataLoaderInterface<TKey, T>
 */
class DataLoader implements DataLoaderInterface
{
    ...
    /**
     * @param callable(array<TKey>): array<T>|Promise<array<T>> $batchLoadFn
     * @param PromiseAdapterInterface<Promise> $promiseFactory;
     */
