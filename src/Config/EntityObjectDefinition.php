...
class EntityObjectDefinition extends TypeWithOutputFieldsDefinition
{
    public function getDefinition(): ArrayNodeDefinition
    {
        $builder = new TreeBuilder('_entity_object_config', 'array');
        ...
        $node
            ...
            ->end()
            ->variableNode('resolveReference')->isRequired()->end()
